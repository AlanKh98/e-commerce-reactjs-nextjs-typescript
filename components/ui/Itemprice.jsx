...
const Cartbtn = (props) =>{
    ...
    return(
        <div className={styles.imgItemPrice}>
              ...
              <p className={styles.oldPrice}>{props.old}</p>
              <p className={styles.greenPrice}>{props.new}</p>
              <div className={styles.priceFaivCon}>
                <Button />
                    <div className={styles.svgContain} onClick={() => {setDisplayHeart(!displayHeart);console.log(displayHeart)}}>
